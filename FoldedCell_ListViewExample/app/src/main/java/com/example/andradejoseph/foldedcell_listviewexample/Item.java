...
/**
 * Created by ANDRADEJOSEPH on 1/9/2017.
 */
...
public class Item {
    ...
    public Item(String price, String pledgePrice, String fromAddress, String toAddress, int requestsCount, String date, String time, String sender) {
        this.price = price;
...
//    }
    ...
    public static ArrayList<Item> getTestingList() {
        ...
        items.add(new Item("$14", "$270", "W 79th St, NY, 10024", "W 139th St, NY, 10030", 3, "TODAY", "05:10 PM", "Joseph"));
        items.add(new Item("$23", "$116", "W 36th St, NY, 10015", "W 114th St, NY, 10037", 10, "TODAY", "11:10 AM", "Karen"));
        items.add(new Item("$63", "$350", "W 36th St, NY, 10029", "56th Ave, NY, 10041", 0, "TODAY", "07:11 PM", "Honeleth"));
        items.add(new Item("$19", "$150", "12th Ave, NY, 10012", "W 57th St, NY, 10048", 8, "TODAY", "4:15 AM", "Keenan"));
        items.add(new Item("$5", "$300", "56th Ave, NY, 10041", "W 36th St, NY, 10029", 0, "TODAY", "06:15 PM", "Rhea"));
        return items;
