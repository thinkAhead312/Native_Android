...
public class FoldingCellListAdapter extends ArrayAdapter<Item> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (cell == null) {
            ...
            viewHolder.sender = (TextView) cell.findViewById(R.id.content_avatar_title);
            viewHolder.relativeLayout = (RelativeLayout) cell.findViewById(R.id.content_avatar_relative_layout);
...
//                Toast.makeText(getContext(), "Karen", Toast.LENGTH_SHORT).show();
