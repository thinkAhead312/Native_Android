...
public class DatabaseInitializer {
    ...
    public static void insertNewLoan(AppDatabase db) {
        User user2 = addUser(db, "2", "Mike", "Seaver", 12);
        Book book1 = addBook(db, "50", "Change12");
            ...
            addLoan(db, "6", user2, book1, lastWeek, today);
//            Thread.sleep(DELAY_MILLIS);
    ...
    private static void populateWithTestData(AppDatabase db) {
        ...
        User user2 = addUser(db, "2", "Mike", "Seaver", 12);
        addUser(db, "3", "Joseph", "Seaver", 15);

        Book book1 = addBook(db, "1", "G12");
