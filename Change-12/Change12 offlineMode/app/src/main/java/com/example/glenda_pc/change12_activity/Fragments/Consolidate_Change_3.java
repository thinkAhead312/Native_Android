...
public class Consolidate_Change_3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_consolidate__change_3, container, false);
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        switch (item.getItemId()) {
                            ...
                            case R.id.myCalendar:
                                ...
                                intent.putExtra("cellStr", "Change 3");
    ...
    public void getList(){
        databaseAccess.open();
        databaseAccess.queryChange12("Change 3");
