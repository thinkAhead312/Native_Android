...
public class Consolidate_Change_1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_consolidate__change_1, container, false);
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        switch (item.getItemId()) {
                            ...
                            case R.id.myCalendar:
                                ...
                                intent.putExtra("cellStr", "Change 1");
    ...
    private void parseData() {
        ...
        for(int i = 0; i<databaseAccess.resultSet.length(); i++) {
            ...
            try {
                ...
                disciple_set_get.setDateUpdated(json.getString("dateUpdated"));
            } catch (JSONException e) {
                e.printStackTrace();
            }
