...
public class Consolidate_Change_4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_consolidate__change_4, container, false);
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        switch (item.getItemId()) {
                            ...
                            case R.id.myCalendar:
                                ...
                                intent.putExtra("cellStr", "Change 4");
    ...
    public void getList(){
        databaseAccess.open();
        databaseAccess.queryChange12("Change 4");
