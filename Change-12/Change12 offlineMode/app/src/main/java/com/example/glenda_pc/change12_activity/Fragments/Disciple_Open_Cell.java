 ...
 * {@link Disciple_Open_Cell.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Disciple_Open_Cell#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Disciple_Open_Cell extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        this.databaseAccess = DatabaseAccess.getInstance(context);
         rootView = inflater.inflate(R.layout.fragment_disciple__open__cell, container, false);
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        switch (item.getItemId()) {
                            ...
                            case R.id.myCalendar:
                                ...
                                intent.putExtra("cellStr", "Open Cell");
    ...
    public void getList(){
        databaseAccess.open();
        databaseAccess.queryOpenCellDisciples();
