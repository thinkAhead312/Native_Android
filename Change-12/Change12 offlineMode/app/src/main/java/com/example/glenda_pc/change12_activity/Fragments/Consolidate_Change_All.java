...
public class Consolidate_Change_All extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_consolidate__change__all, container, false);
        ...
        //txtCloseCell.setText(String.valueOf((int) (height*.70)));
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()) {
                            ...
                            case R.id.myCalendar:
                                ...
                                intent.putExtra("cellStr", "All Consolidates");
